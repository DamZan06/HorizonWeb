...
const T={en:{na:'Not available',live:'Live',delayed:'Delayed',resting:'Resting',ended:'End of day',finished:'Finished',prestart:'Not started',recent:'Based on the last hour of movement',moving:'Based on average moving speed'},it:{na:'Non disponibile',live:'Live',delayed:'Segnale in ritardo',resting:'In sosta',ended:'Fine giornata',finished:'Conclusa',prestart:'Non iniziata',recent:"Basato sull’ultima ora in movimento",moving:'Basato sulla velocità media in movimento'},de:{na:'Nicht verfügbar',live:'Live',delayed:'Signal verzögert',resting:'Pause',ended:'Tagesende',finished:'Beendet',prestart:'Nicht gestartet',recent:'Basierend auf der letzten Bewegungsstunde',moving:'Basierend auf der durchschnittlichen Bewegungsgeschwindigkeit'},fr:{na:'Indisponible',live:'En direct',delayed:'Signal retardé',resting:'À l’arrêt',ended:'Fin de journée',finished:'Terminée',prestart:'Non commencée',recent:'Basé sur la dernière heure en mouvement',moving:'Basé sur la vitesse moyenne en mouvement'}};
