(function () {
    ...
    async function renderAchievementOverride(type) {
        ...
        if (current) current.textContent = `${tr("admin.automaticGpsDetectionActive", "Automatic GPS detection active")} · ${selected.size}/5 ${tr("admin.manuallyActivated", "manually activated")}.`;
    }
